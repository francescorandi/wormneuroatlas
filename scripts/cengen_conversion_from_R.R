...
h5write(dimnames(cengen_sc_2_bulk)[[2]],h5fname,"cengen_sc_2_neuron_ids")
h5write(dimnames(cengen_sc_2_bulk)[[1]],h5fname,"cengen_sc_2_gene_wbids")
h5write(dimnames(cengen_sc_3_bulk)[[2]],h5fname,"cengen_sc_3_neuron_ids")
h5write(dimnames(cengen_sc_3_bulk)[[1]],h5fname,"cengen_sc_3_gene_wbids")
h5write(dimnames(cengen_sc_4_bulk)[[2]],h5fname,"cengen_sc_4_neuron_ids")
h5write(dimnames(cengen_sc_4_bulk)[[1]],h5fname,"cengen_sc_4_gene_wbids")
